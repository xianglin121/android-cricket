...
public class MessageInfo implements Serializable {
     ...
     * 收到礼物消息
     */
    public static final int MSG_TYPE_GIFT = 100;
    /**
     * 收到彩色弹幕消息
     */
    public static final int MSG_TYPE_COLOR_DANMU = 101;
    /**
     * 收到用户进房间消息
     */
    public static final int MSG_TYPE_NOBEL_ENTER = 102;
    /**
     * 收到喇叭消息
     */
    public static final int MSG_TYPE_BROADCAST = 104;
    /**
     * 收到炫彩弹幕消息
     */
    public static final int MSG_TYPE_BG_DANMU = 105;
    /**
     * 红包消息
     */
    public static final int MSG_TYPE_RED_ENVELOPE = 106;
    ...
    private Bitmap expIcon;
    private Bitmap nobleIcon;
    ...
    public Bitmap getExpIcon() {
        return expIcon;
    }

    public void setExpIcon(Bitmap expIcon) {
        this.expIcon = expIcon;
    }

    public Bitmap getNobleIcon() {
        return nobleIcon;
    }

    public void setNobleIcon(Bitmap nobleIcon) {

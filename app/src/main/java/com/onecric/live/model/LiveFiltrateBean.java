...
public class LiveFiltrateBean {
    ...
    public void setStartLike(Integer startLike) {
    ...
    public Integer getHotvotes() {
        return hotvotes;
    }

    public void setHotvotes(Integer hotvotes) {
    ...
    public String getVotestotalIcon() {
        return votestotalIcon;
    }

    public void setVotestotalIcon(String votestotalIcon) {
        this.votestotalIcon = votestotalIcon;
    }

    public ClarityBean getClarity() {
        return clarity;
    }

    public void setClarity(ClarityBean clarity) {

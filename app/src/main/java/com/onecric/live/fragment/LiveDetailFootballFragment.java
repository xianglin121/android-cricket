...
public class LiveDetailFootballFragment extends Fragment implements View.OnClickListener {
    public static LiveDetailFootballFragment newInstance(int id) {
        LiveDetailFootballFragment fragment = new LiveDetailFootballFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_live_detail_football, null);
        return rootView;
    }
    ...
    private void initData() {
        ...
        mTitles.add(WordUtil.getString(getContext(), R.string.match_lineup));

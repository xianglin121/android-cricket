 ...
 * 时间：2022/8/26
 */
public class CricketListFragment extends MvpFragment<CricketPresenter> implements CricketView, View.OnClickListener {
    public static CricketListFragment newInstance(String timeType) {
        CricketListFragment fragment = new CricketListFragment();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_cricket_list;
    }
    ...
    protected void initData() {
        ...
        smart_rl.setOnRefreshListener(refreshLayout -> mvpPresenter.getCricketMatchList(true, mTimeType, mTournamentId, 0, 1));
        smart_rl.setOnLoadMoreListener(refreshLayout -> mvpPresenter.getCricketMatchList(false, mTimeType, mTournamentId, 0, mPage));
        mAdapter = new CricketNewAdapter((MainActivity) getActivity(),R.layout.item_cricket_new, new ArrayList<>());
...
//        });
        ...
        mvpPresenter.getCricketMatchList(true, mTimeType, mTournamentId, 0, 1);
    }
